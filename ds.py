...
acil = PRANKBOTS.LINE() 
acil.login(token="EtubUJ68hJlvubU0K6H9.tJMxRtazVZT1pqzL9twcUq.B+vRwqajUpwhRRm3G5OJ400k4ZpgXmttYe+u6SRYxwo=")
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="EtJN4XB2hddywX2babf0.QYde7oALGh7T4SLLcFpgya.riMmr5ehMR90inyIFX0TMgmdrvhDLSsGxkrtuAhSZ6Y=")
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="EtpjvZ5khR8qAtRVbNw8.fcoMlPFAcKPyUFmdtX0GUa.Eqg5s9D5VlWRC3q2XqvMzTuNnh/H57bsKed43JJqTHo=")
pb2.loginResult()
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u4e3997ad3019bf3b753d0665f53582b9":
                    if "join:" in msg.text:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u530b8459bbe36cc0652f7f976d9d917c'}
                acil.sendMessage(msg)
...
#--------------------------------------------------------
                ...
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        acil.sendText(msg.to,"Invite Protect Enable 􀜁􀇔??👈")
                    else:
                        acil.sendText(msg.to,"Hal ini sudah terbuka ô€¨👈")
                else:
